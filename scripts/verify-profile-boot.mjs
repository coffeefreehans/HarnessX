...
const BIN_NAME = 'harnessx-desktop-profile-smoke'
...
try {
  ...
  const runtime = {
    ...
    // The headless smoke has no Electron cookie jar; its in-process requests are trusted.
    authorizeLocalApiRequest() { return true },
    schedule(spec) {
      mountedSpec = spec
      return async () => {}
    },
