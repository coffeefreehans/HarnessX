...
const BIN_NAME = 'harnessx-desktop-loader-smoke'
...
try {
  ...
  if (profileRequire.resolve('harnessx-desktop/package.json') !== desktopManifest) {
  ...
  if (profileDirectoryRequire.resolve('harnessx-desktop/package.json') !== desktopManifest) {
  ...
  ctx = await boot(
    ...
    prepared.rootConfig,
    [{ insert: [
      { id: 'desktop-shell', name: 'harnessx-desktop' },
  ...
  if (desktopEntry?.options.name !== 'harnessx-desktop') {
