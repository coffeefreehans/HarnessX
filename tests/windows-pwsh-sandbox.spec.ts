...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\HarnessX\\HarnessX.exe',
  upstreamRunner: 'C:\\Program Files\\HarnessX\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\HarnessX\\resources\\app.asar\\desktop-runner.js',
}
