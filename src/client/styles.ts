...
.dshDesktopDetailsOverlay { position: absolute; z-index: 900; top: 0; right: 0; bottom: 0; min-width: 0; overflow: hidden; background: var(--dsw-alias-bg-base); border-left: 1px solid var(--dsw-alias-border-l2); box-shadow: var(--ds-shadow-lg, 0 8px 24px rgba(0,0,0,0.24)); }
...
export function installAdvancedStyles(): () => void {
  ...
  style.dataset.pluginCss = 'harnessx-desktop/advanced-shell'
