...
- This project pins the published DSH `0.1.5-rc.1` family, matching the sibling `deepseek-harness/` source checkout (dsh-v0.1.5-rc.1). Tests therefore validate the published package interfaces.
