...
- This project pins the published DSH `0.1.1-rc.2` family, matching the sibling `deepseek-harness/` source checkout (dsh-v0.1.1-rc.2). Tests therefore validate the published package interfaces.
