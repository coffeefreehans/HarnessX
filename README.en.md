...
| --- | --- |
| Windows x64 | [Download EXE](https://github.com/coffeefreehans/HarnessX/releases/download/v0.1.9/HarnessX-0.1.9-x64-Setup.exe) |
| Windows ARM64 | [Download EXE](https://github.com/coffeefreehans/HarnessX/releases/download/v0.1.9/HarnessX-0.1.9-arm64-Setup.exe) |
| macOS Intel x64 | [Download DMG](https://github.com/coffeefreehans/HarnessX/releases/download/v0.1.9/HarnessX-0.1.9-x64.dmg) |
| macOS Apple Silicon ARM64 | [Download DMG](https://github.com/coffeefreehans/HarnessX/releases/download/v0.1.9/HarnessX-0.1.9-arm64.dmg) |

[SHA-256 checksums](https://github.com/coffeefreehans/HarnessX/releases/download/v0.1.9/SHA256SUMS.txt)
